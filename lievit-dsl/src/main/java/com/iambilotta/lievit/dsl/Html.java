...
/**
 * A node in lievit's type-safe HTML tree, the single-file authoring surface (ADR-0003, ADR-0015).
 *
 ...
 * {@link #render()}.
 *
 * <p>The security property is <strong>escape-by-construction</strong> (ADR-0015): every {@link
