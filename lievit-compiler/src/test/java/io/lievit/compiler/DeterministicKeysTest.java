...
class DeterministicKeysTest {
    ...
    void generates_the_golden_lw_crc32_counter_key() {
        // crc32("io.lievit.RowComponent") = 0x5372a397 (verified against zlib.crc32).
        assertThat(DeterministicKeys.of("io.lievit.RowComponent", 0)).isEqualTo("lw-5372a397-0");
        assertThat(DeterministicKeys.of("io.lievit.RowComponent", 2)).isEqualTo("lw-5372a397-2");
    }
    ...
    void the_generator_drives_a_scope_with_an_advancing_counter() {
        var scope = new io.lievit.component.DeterministicKeyScope(DeterministicKeys.GENERATOR);
        scope.enter("io.lievit.RowComponent");

        assertThat(scope.nextKey()).isEqualTo("lw-5372a397-0");
        assertThat(scope.nextKey()).isEqualTo("lw-5372a397-1");
        assertThat(scope.nextKey()).isEqualTo("lw-5372a397-2");
    }
}
