...
class ViewConverterTest {
    ...
    void converts_single_file_to_multi_file() {
        ...
        assertThat(result.classSource()).doesNotContain("import static io.lievit.dsl.H");
        assertThat(result.classSource()).doesNotContain("io.lievit.dsl.Html");
    ...
    void converts_multi_file_back_to_single_file() {
        ...
        assertThat(back.classSource()).contains("import static io.lievit.dsl.H.*;");
