...
class TypedStateRoundTripInvariantTest {
    ...
    void mount_dehydrates_typed_state_to_tuples() {
        ...
        assertThat(dev.lievit.wire.synth.Dehydrated.isEnvelope(mounted.wire().get("listing")))
                .isTrue();
        assertThat(dev.lievit.wire.synth.Dehydrated.isEnvelope(mounted.wire().get("publishOn")))
                .isTrue();
    }
