...
/**
 * The authorization seam the dispatcher consults before invoking a {@link io.lievit.LievitAction}
 * (issue #57). Pure Java, zero Spring (ADR-0007): the core knows only "ask before you invoke"; the
 * starter binds a Spring-Security-backed implementation that evaluates {@link io.lievit.LievitAuthorize}
 ...
 * {@link io.lievit.wire.WireError#FORBIDDEN_ACTION} and the action body never executes.
 *
...
public interface ActionAuthorizer {
     ...
     *     carries any {@link io.lievit.LievitAuthorize} / {@code @PreAuthorize} annotations
