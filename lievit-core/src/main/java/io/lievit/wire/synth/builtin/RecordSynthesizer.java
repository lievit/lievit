 ...
 * the {@link io.lievit.wire.synth.ClassInstantiationGuard} before the constructor runs (ADR-0021),
 * so a denied class never reaches reflection. A user type that wants control or native-safety
 * implements {@link io.lievit.wire.synth.Wireable} instead (preferred by the registry).
 *
