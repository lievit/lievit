...
/**
 * The reflected shape of a {@link LievitFormObject} class: its bindable fields (ADR-0017).
 *
...
public final class FormObjectMetadata {
    ...
    public static FormObjectMetadata of(Class<?> type) {
        ...
        for (Field field : type.getDeclaredFields()) {
            ...
            // Reject nested form objects (bounded depth, ADR-0017 §Security).
            if (LievitFormObject.class.isAssignableFrom(field.getType())) {
                throw new IllegalArgumentException(
                        "form object field '"
                                ...
                                + " not supported (max depth 1, ADR-0017)");
            }
