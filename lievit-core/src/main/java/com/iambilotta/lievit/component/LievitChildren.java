 ...
 * parent mounts during its render (ADR-0015, nested components). A parent declares a child via
 ...
 * the depth ({@code lievit.max-nesting-depth}, ADR-0013/ADR-0015) so an accidental render cycle
