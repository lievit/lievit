...
/**
 * One child a parent component mounted inside its render (ADR-0015, nested components). It names the
 ...
 *
 * <p>{@code props} is plain JSON data (the {@link com.iambilotta.lievit.wire.PayloadGuard}
 * allowlist): a parent passing an opaque object down is the same gadget surface a client update is,
 * so props ride through the same shape check (ADR-0013, ADR-0015).
 *
