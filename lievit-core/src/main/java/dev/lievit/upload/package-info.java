 ...
 * ({@link dev.lievit.upload.TempFileSigner}), path-traversal rejection, expiry-bounded preview
 * tokens, and extension/size validation ({@link dev.lievit.upload.UploadConstraints}).
 *
