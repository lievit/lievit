 ...
 * ({@link dev.lievit.pagination.OffsetPage}, {@code paginate()}) and keyset/cursor
 * ({@link dev.lievit.pagination.CursorPage}, {@code cursorPaginate()}) page values, the
 * {@link dev.lievit.pagination.Paginators} factory over an adopter-supplied data SPI, and the
 * {@link dev.lievit.pagination.PageState} {@code $page} state with named pages + page-reset-on-filter.
 *
