 ...
 * {@link dev.lievit.wire.PayloadGuard} nesting cap on the inbound update path (ADR-0013), so a
...
public final class DynamicObject {
     ...
     * the {@link dev.lievit.wire.synth.builtin.DynamicObjectSynthesizer} on hydrate.
     *
