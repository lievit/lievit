...
/**
 * The built-in {@link dev.lievit.wire.synth.Synthesizer} set: the JVM analogues of Livewire's synth
 ...
 * {@link dev.lievit.wire.synth.SynthesizerRegistry} (ADR-0020). Pure Java, zero Spring (ADR-0007).
 */
@NullMarked
