...
/**
 * One field of a {@link dev.lievit.LievitFormObject}, reflected and made accessible for
 * hydration and dehydration (ADR-0017).
 *
 ...
 * type is a {@link dev.lievit.LievitFormObject} carries the form object's value in
...
public record FormField(String name, Field field) {
     ...
     *     {@link dev.lievit.wire.synth.SynthesizerRegistry} for a typed round-trip (a
