...
class ComponentAssetEmitterTest {
    ...
    void resolves_a_built_script_module_to_its_hashed_url() {
        // io/lievit/spring/asset/Widget.lievit.ts is the colocated module of the test fixture.
        String moduleSrc = "io/lievit/spring/asset/Widget.lievit.ts";
        ...
        WireEffects.Assets assets = emitter.emit(io.lievit.spring.asset.Widget.class, new HashSet<>());
        ...
        assertThat(assets.styleModules().get(0).component())
                .isEqualTo(io.lievit.spring.asset.Widget.class.getName());
    ...
    void falls_back_to_the_dev_module_route_without_a_manifest() {
        ...
        assertThat(assets.scripts())
                .containsExactly("/lievit/module/io/lievit/spring/asset/Widget.lievit.ts");
    }
    ...
    void ships_each_asset_once_per_page() {
        ...
        assertThat(emitter.emit(io.lievit.spring.asset.Widget.class, seen)).isNotNull();
        assertThat(emitter.emit(io.lievit.spring.asset.Widget.class, seen)).isNull();
    }
}
