...
import dev.lievit.spring.WireCallRequest;
import dev.lievit.spring.WireEffects;
 ...
 * dev.lievit.spring.LievitAutoConfiguration}, so it applies to every lievit app without
