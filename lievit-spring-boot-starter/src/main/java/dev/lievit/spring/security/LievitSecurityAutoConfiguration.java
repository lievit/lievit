 ...
 */
package dev.lievit.spring.security;
...
import dev.lievit.component.ActionAuthorizer;
 ...
 *       the engine that evaluates {@link dev.lievit.LievitAuthorize} / {@code @PreAuthorize} SpEL. When
