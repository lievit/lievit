...
import dev.lievit.component.ChildComponent;
...
final class ChildRenderer {
    ...
    private String mountChild(ChildComponent child, int depth) {
        ...
        dev.lievit.component.ComponentStack stack = dev.lievit.component.ComponentStack.current();
        if (stack != null) {
        ...
        dev.lievit.component.LievitSlots.bindFor(child.slots());
        WireCall mounted;
        String childHtml;
        try {
            ...
            dev.lievit.component.LievitSlots.clearFor();
            if (stack != null) {
                stack.pop();
            }
        }
    ...
    private static String substituteSlots(
        ...
        for (java.util.Map.Entry<String, String> entry : slots.entrySet()) {
            ...
            html = html.replace(dev.lievit.component.LievitSlots.placeholderFor(name), wrapped);
        }
    ...
    private static String placeholder(String key) {
        return dev.lievit.component.LievitChildren.placeholderFor(key);
    }
