...
import dev.lievit.upload.DirectUpload;
import dev.lievit.upload.DirectUploadProvider;
import dev.lievit.upload.InvalidTempPathException;
import dev.lievit.upload.SignedTempPath;
 ...
 * unary wire dispatcher ({@link dev.lievit.spring.LievitWireController}) so it adds a route, not a
