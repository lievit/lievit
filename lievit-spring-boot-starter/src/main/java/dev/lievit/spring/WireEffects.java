...
import dev.lievit.component.DispatchedEvent;
import dev.lievit.component.DownloadEffect;
 ...
 * map set by the dispatcher when {@link dev.lievit.component.FieldValidator} returns
 ...
 *     {@link dev.lievit.component.FieldValidator} found constraint violations; absent
...
public record WireEffects(
    ...
    private static @Nullable Transition toTransition(
            dev.lievit.component.@Nullable TransitionEffect t) {
        if (t == null) {
            return null;
        }
