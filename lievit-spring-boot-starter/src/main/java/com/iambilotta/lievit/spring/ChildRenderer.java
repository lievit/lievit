...
import com.iambilotta.lievit.component.ChildComponent;
 ...
 * parent's placeholders (ADR-0015, nested components). Pulled out of {@link LievitWireService} so the
 ...
 * contract with the sibling client bundle, see {@code docs/adr/0015}):
 *
 * <ul>
...
final class ChildRenderer {
     ...
     * back up to the parent's bound property (ADR-0015; the up-leg of the two-way bind). No marker
    ...
    private static String placeholder(String key) {
        return com.iambilotta.lievit.component.LievitChildren.placeholderFor(key);
    }
