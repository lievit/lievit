 ...
 *
 * <ul>
 *   <li>{@link com.iambilotta.lievit.kit.AdminResource} is the unit of work, one per domain entity,
 ...
 *   <li>{@link com.iambilotta.lievit.kit.AdminForm} and {@link com.iambilotta.lievit.kit.AdminTable}
 *       share the common parent {@link com.iambilotta.lievit.kit.AdminSchema} from v0.1, so the
 *       builders never need a later breaking unification (the Filament v3-&gt;v4 Schema lesson).
 *   <li>{@link com.iambilotta.lievit.kit.AdminPage} (the annotation) makes a standalone page a
 *       first-class peer of {@code AdminResource}, not a second-class escape hatch.
 *   <li>{@link com.iambilotta.lievit.kit.AdminRenderHook} are named injection points: adopters
 *       extend the layout there instead of forking published views.
 *   <li>{@link com.iambilotta.lievit.kit.AdminRecordRepository} is a persistence-agnostic port: the
 *       adopter wires the data, the kit never hard-codes JdbcClient or JPA.
 *   <li>{@link com.iambilotta.lievit.kit.AdminPanelPlugin} is the third-party extension point, the
