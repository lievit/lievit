...
/**
 * Marks a standalone admin page: a first-class peer of {@link AdminResource}, not a second-class
 * escape hatch (the explicit filament-internals.md correction of Filament's "everything is a
 * Resource" rigidity).
 *
 * <p>A {@code @AdminPage} is placed on a lievit component class (one that also carries
