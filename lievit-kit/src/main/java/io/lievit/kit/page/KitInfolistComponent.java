 ...
 * into the {@link io.lievit.kit.AdminViewView}, gate through the {@link AdminAuthorizer}) and adds the
...
public final class KitInfolistComponent<T> {
    ...
    /**
     * Wraps a bounded {@link io.lievit.kit.AdminViewView} with the resource's back-to-list href (the
     ...
     */
    public KitInfolistView decorate(io.lievit.kit.AdminViewView view) {
