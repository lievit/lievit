 ...
 * ({@link io.lievit.kit.page.ListPageDriver},
 * {@link io.lievit.kit.page.FormPageDriver}) that a concrete page component composes,
 * declaring its own wire fields + actions and delegating the logic here. This mirrors the hello-admin
 * list component delegating to {@link io.lievit.kit.AdminListView}.
 *
 * <p>This is <strong>full-page</strong> CRUD only (List / Create / Edit at distinct URLs, navigation
 * via the {@link io.lievit.component.LievitEffects} redirect substrate). Modal /
