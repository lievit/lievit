 ...
 * {@link dev.lievit.kit.support.EvaluationContext.Operation#VIEW VIEW}, and producing the
 * {@link AdminViewView} (the already-projected label-to-display sections + the header actions). The
 * read is bounded to one record (a single {@link dev.lievit.kit.RecordRepository#findById}); a
...
public final class ViewPageDriver<T> {
     ...
     * back-to-list link (secondary). The richer {@link dev.lievit.kit.AdminAction} header placement
     * (K3) layers on top.
     */
