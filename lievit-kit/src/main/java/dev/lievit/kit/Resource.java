...
public abstract class Resource<T> {
    ...
    /**
     * Builds the read-only {@link dev.lievit.kit.schema.infolist.Infolist Infolist} the resource's
     ...
     */
    public Optional<dev.lievit.kit.schema.infolist.Infolist> infolist() {
        return Optional.empty();
    }
