 ...
 * partial emits, through the {@link dev.lievit.kit.support.ColorManager} and {@link
 * dev.lievit.kit.support.IconManager}. It deliberately stops at the seam: it does not own the JTE
 * markup or rewrite the lievit-ui components, it gives the kit's surfaces one composable place to ask
 * "what classes does a primary large button get?". {@link dev.lievit.kit.component.ComponentViews}
 * dogfoods it by rendering an {@link dev.lievit.kit.AdminAction} and an {@link
 * dev.lievit.kit.AdminNotification} through these views.
 */
