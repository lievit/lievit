...
import dev.lievit.spring.broadcast.BroadcastChannel;
import dev.lievit.spring.broadcast.BroadcastEvent;
...
public final class BroadcastNotification {
    ...
    public static final String BELL_COMPONENT = "dev.lievit.kit.NotificationBell";
