...
import io.lievit.kit.relationselect.RelationSelectTestApp.CountingPersonRepository;
import io.lievit.spring.LievitWireService;
import io.lievit.spring.WireCallResult;

/**
 * The K5 exit gate: the kit searchable relation field ({@link io.lievit.kit.BelongsToField} in
