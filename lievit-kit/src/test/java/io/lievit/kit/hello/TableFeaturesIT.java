...
class TableFeaturesIT {
     ...
     *     {@link io.lievit.kit.ColumnGroup} (a spanning super-header over two columns)
    ...
    /**
     * @spec.given the worked ListingResource declaring a {@link io.lievit.kit.ViewColumn} ("Score")
     ...
     *     {@link io.lievit.kit.TernaryFilter} ("big": trueLabel "Big cities", falseLabel
    ...
    /**
     * @spec.given the worked ListingResource declaring a {@link io.lievit.kit.SelectFilter} over the
