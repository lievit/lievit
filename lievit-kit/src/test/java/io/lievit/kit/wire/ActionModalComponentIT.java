 ...
 * {@link io.lievit.kit.FormAction} driven through the REAL lievit runtime by
 * {@link ActionModalComponent}. It proves the audit's three action rows render / behave their
 * defining sub-features:
 *
 * <ul>
 *   <li><b>action modals</b>: the deepened {@link io.lievit.kit.ModalConfig} renders the width token,
