...
public class ActionModalComponent {
    ...
    private final FormAction<io.lievit.kit.wire.ActionFixtures.Message> action;
    private final Resource<io.lievit.kit.wire.ActionFixtures.Message> resource;
    ...
    public ActionModalComponent(
            FormAction<io.lievit.kit.wire.ActionFixtures.Message> action,
            Resource<io.lievit.kit.wire.ActionFixtures.Message> resource) {
        this.action = action;
    ...
    @LievitAction
    public void submit() {
        AdminActionContext<io.lievit.kit.wire.ActionFixtures.Message> context =
    ...
    public FormAction<io.lievit.kit.wire.ActionFixtures.Message> action() {
        return action;
    }
