 ...
 * resolved {@link dev.lievit.kit.schema.infolist.Infolist Infolist} (the "view in panel" outcome,
...
class SlideOverComponentIT {
        ...
        org.assertj.core.api.Assertions.assertThatThrownBy(
                        () ->
                                wireService.call(
                                        ...
                                        List.of("open"),
                                        "test-client"))
                .isInstanceOf(dev.lievit.wire.WireException.class)
                .extracting(e -> ((dev.lievit.wire.WireException) e).error())
                .isEqualTo(dev.lievit.wire.WireError.LOCKED_PROPERTY);
    }
    ...
    private static dev.lievit.kit.hello.ListingResource slideOverResource() {
        return new dev.lievit.kit.hello.ListingResource(
                new dev.lievit.kit.hello.InMemoryListingRepository(),
