 ...
 * + dispatcher + JTE adapter), proving an {@link dev.lievit.kit.schema.infolist.Infolist Infolist} is
 * resolved over one record under VIEW and the {@link dev.lievit.kit.AdminViewView} is rendered as the
