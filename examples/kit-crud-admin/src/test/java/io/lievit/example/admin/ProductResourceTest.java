 ...
 */
package io.lievit.example.admin;
...
class ProductResourceTest {
    ...
    void valid_state_saves_a_new_product() {
        ...
        long before = repo.page(io.lievit.kit.RecordRepository.Query.of(0, 100)).total();
        ...
        assertThat(repo.page(io.lievit.kit.RecordRepository.Query.of(0, 100)).total())
                .isEqualTo(before + 1);
    }
    ...
    void invalid_state_fails_with_field_errors() {
        ...
        assertThat(result.errors())
                .extracting(io.lievit.kit.FieldError::field)
                .contains("name", "price");
    }
}
